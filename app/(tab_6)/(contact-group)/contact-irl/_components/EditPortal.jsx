...
export default function EditPortal() {
  ...
  // ---------------------------------- states ----------------------------------
  const { editConditionIRLModal } = useSelector(
              ...
              <div className="modal-content">
                <div className="modal-header modal--header">
                  ...
                  <button
                    type="button"
                    className="btn-close"
                    onClick={() => dispatch(toggleEditConditionIRLModal(false))}
                ...
                <div className="modal-footer">
                  <button
                    ...
                    type="button"
                    onClick={() =>
                      dispatch(toggleEditConditionIRLModal(false))
                    }>
                    Close
                  </button>
                  <button
