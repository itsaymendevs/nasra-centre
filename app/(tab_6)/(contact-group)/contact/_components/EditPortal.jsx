...
import { toggleEditConditionSDModal } from '@/slices/SixthModalSlice';
...
export default function EditPortal() {
  ...
  // ---------------------------------- states ----------------------------------
  const { editConditionSDModal } = useSelector(
              ...
              <div className="modal-content">
                <div className="modal-header modal--header">
                  ...
                  <button
                    type="button"
                    className="btn-close"
                    onClick={() => dispatch(toggleEditConditionSDModal(false))}
