          ...
          <div className="btn-group-vertical w-100" role="group">
            ...
            <div className="btn-group dropend navbar--split-btn">
              <button
                ...
                <Link className="stretched-link regulate--link" href="/">
                  Products
                </Link>
              </button>
            ...
            <div className="btn-group dropend navbar--split-btn">
              <button
                ...
                <Link className="stretched-link regulate--link" href="/general">
                  General Info
                </Link>
              </button>
              ...
              <div className="dropdown-menu dropdown-menu-dark results--dropdown-menu">
                ...
                <Link className="dropdown-item" href="/sms/uk">
                  Messages - UK
                </Link>
                <Link className="dropdown-item" href="/advertisements">
                  Advertisements
                </Link>
              </div>
            </div>
