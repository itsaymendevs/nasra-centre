  ...
  return (
    <div id="results--row">
      ...
      <div className="row g-0 align-items-center results--item">
        <div className="col-2">
          <label className="col-form-label form--label row--label">U-001</label>
        </div>
        <div className="col-2">
          <label className="col-form-label form--label row--label">
            Kilogram
        ...
        <div className="col-2">
          <label className="col-form-label form--label row--label">KG</label>
        </div>
        <div className="col-2">
          <label className="col-form-label form--label row--label">
            كيلوجرام
        ...
        <div className="col-3">
          <label className="col-form-label form--label row--label">كج</label>
        </div>
        <div className="col-1">
          <button
            className="btn btn--raw-icon edit scale--3"
            type="button"
            onClick={() => dispatch(toggleEditUnitModal(true))}>
            <svg
